...
describe('KPICards', () => {
  it('renders all three KPI values', () => {
    render(<KPICards personalIPC={3.5} officialIPC={2.1} difference={1.4} />)
  ...
  it('shows negative values without plus sign', () => {
    render(<KPICards personalIPC={-1.2} officialIPC={-0.5} difference={-0.7} />)
