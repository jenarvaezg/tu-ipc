...
const QUESTIONS: Question[] = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        emoji: '💼',
        deltas: { '04': 4, '11': 5, '09': 2, '01': -4, '05': -3, '06': -2, '10': -1 },
        insight:
      ...
      },
      {
        label: 'Jubilado/a',
        emoji: '🏖️',
        deltas: { '01': 5, '06': 5, '12': 2, '07': -5, '09': -2, '11': -4, '10': -1 },
        insight:
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        insight: 'Combinar medios reduce algo el peso de transporte respecto al oficial.',
        affected: [
          { code: '07', direction: 'down' },
          { code: '11', direction: 'up' },
        ],
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        emoji: '⚖️',
        deltas: {},
        insight: 'Tu reparto entre alimentación y restaurantes se acerca a la media oficial.',
        affected: [],
      },
      {
    ...
    options: [
      {
        ...
        emoji: '✅',
        deltas: { '10': -1, '11': 1 },
        insight: 'Sin gastos educativos, esta categoría casi no afecta a tu inflación personal.',
        affected: [
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        emoji: '🏘️',
        deltas: {},
        insight: 'En ciudades medianas, la distribución del gasto se acerca a la media oficial.',
        affected: [],
      },
      {
...
export default function OnboardingQuiz({ onComplete, onSkip }: OnboardingQuizProps) {
      ...
      <div className="max-w-lg mx-auto">
        ...
        <Card>
          <CardContent className="pt-6">
            <h3 className="text-xl font-bold mb-1 text-center">Tu perfil de consumo</h3>
            ...
            <p className="text-xs text-muted-foreground text-center mb-4">
              Puedes ajustar estos pesos después en la pestaña &quot;Desglose&quot;.
            </p>
  ...
  const currentOption = selectedOption !== null ? question.options[selectedOption] : null
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <Card>
        <CardContent className="pt-6">
          {/* Question text */}
          <h3 className="text-lg font-semibold mb-3 text-center">{question.text}</h3>
